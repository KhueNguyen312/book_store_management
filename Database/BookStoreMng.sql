...
ALTER TABLE CTPHIEUNHAP ADD CONSTRAINT F_K_CTPN_SACH FOREIGN KEY (MASACH) REFERENCES SACH 
 GO
 ALTER TABLE dbo.CTKHUYENMAI ADD CONSTRAINT F_K_MASACH FOREIGN KEY (MASACH) REFERENCES dbo.SACH
 GO
 ALTER TABLE dbo.CTKHUYENMAI ADD CONSTRAINT FK_MAKM FOREIGN KEY (MAKM) REFERENCES dbo.KHUYENMAI
...
END
GO
CREATE PROCEDURE USP_TIMKHTHEOTEN
@TENKH NVARCHAR(50)
AS
BEGIN
	BEGIN TRAN
...
END
GO
CREATE PROCEDURE USP_TIMTKTHEOTEN
@TENTK NVARCHAR(30)
AS
BEGIN
	BEGIN TRAN
